...
uses
  ...
  scAboutBox,
  scHighTimer,
  scImageEffects, // added in 5/29/2010
  //=======================================
...
begin
  ...
  FMSPFRecord            := 20;          // FPS Record rate (1000 = 1 Second)(1 = 1 Millisecond)
  FPlaybackFPS           := 50;          // FPS Playback rate
  FKeyFramesEvery        := 300;         // Default every 300 frames keyframe
  ...
  FRegColor1             := clRed;       // Color 1 of flash capturing region
  FRegColor2             := clLime;      // Color 2 of flash capturing region
  ...
  FScreenArea.FScreenRegion   := FixedMoving; // FixedMoving = Move window by mouse
