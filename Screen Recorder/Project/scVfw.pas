...
function    AVISaveVW(
   ...
   nStreams         : Int;
   pavi             : APAVISTREAM;
   lpOptions        : APAVICOMPRESSOPTIONS
   ): HResult; stdcall;
...
function    AVISaveOptions(
    ...
    uiFlags: UINT;
    nStreams: int;
    var pavi: APAVISTREAM;
    var lpOptions: APAVICOMPRESSOPTIONS
    ): BOOL; stdcall;
...
function    AVISaveV(
   ...
   pavi             : APAVISTREAM;
   lpOptions        : APAVICOMPRESSOPTIONS
   ): HResult; stdcall; external AVIFILDLL name 'AVISaveV';
...
function    AVISaveVW(
    ...
    pavi            : APAVISTREAM;
    lpOptions       : APAVICOMPRESSOPTIONS
    ): HResult; stdcall; external AVIFILDLL name 'AVISaveVW';
...
function    AVISaveOptions(
    ...
    var pavi: APAVISTREAM;
    var lpOptions: APAVICOMPRESSOPTIONS
    ): BOOL; stdcall; external AVIFILDLL name 'AVISaveOptions';
